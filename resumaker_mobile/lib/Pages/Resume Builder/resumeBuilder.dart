...
class _ResumeBuilderState extends State<ResumeBuilder> {
  ...
  // Page 1: AI Chat Assistant (placeholder)
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              "This is where your chat functionality will be implemented.",
              style: TextStyle(
                fontSize: 16,
  ...
  // Page 3: PDF Preview (placeholder)
  ...
  // Helper method to build experience preview
  ...
  // Helper method to build education preview
  ...
  // Helper method to build custom sections preview
